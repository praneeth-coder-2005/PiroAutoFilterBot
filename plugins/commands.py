...
async def start(client, message):
    ...
    if data.startswith("all"):
        ...
        for file in files:
            ...
            await client.send_cached_media(
                ...
                reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('⚔️ WALDY × IRandomGuy ⚔️', url=f"https://t.me/Cinemalu_Adda") ] ] ),
            )
        return
    ...
    if not files_:
        ...
        try:
            msg = await client.send_cached_media(
                ...
                file_id=file_id,
                protect_content=True if pre == 'filep' else False,
                reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('⚔️ WALDY × AND IRandomGuy ⚔️', url="https://t.me/Cinemalu_Adda") ] ] ),
            )
            filetype = msg.media
    ...
    await client.send_cached_media(
        ...
        caption=f_caption,
        protect_content=True if pre == 'filep' else False,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('⚔️ WALDY × IRandomGuy ⚔️', url="https://t.me/Cinemalu_Adda") ] ] ),
    )
